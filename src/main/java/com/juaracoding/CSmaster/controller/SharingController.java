...
import com.juaracoding.CSmaster.dto.TestOne;
import com.juaracoding.CSmaster.dto.TestThree;
import com.juaracoding.CSmaster.dto.TestTwo;
import com.juaracoding.CSmaster.utils.PdfGenaratorUtil;
...
public class SharingController {
    ...
    public String conditionLogic( Model model,WebRequest request) {
        ...
        for (int i=0;i<arr.length;i++)
        {
            for(int j=0;j<arr[i].length;j++)
            {
                System.out.print("Array ke |"+i+"|"+j+"| : "+arr[i][j]+",");
            }
            System.out.println();
        }
        model.addAttribute("arrTitle",arrTitle);
...
//        data.put("to","Huehehehehe");
//        data.put("mapz",mapz);
//        data.put("mapColumnSearch",mapColumnSearch);
//        data.put("arrTitle",arrTitle);
//        data.put("arr",arr);
//        try {
//            pdfGenaratorUtil.createPdf("thymeleaf_template",data);
//        } catch (Exception e) {
