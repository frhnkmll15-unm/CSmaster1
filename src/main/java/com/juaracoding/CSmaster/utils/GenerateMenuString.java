...
import com.juaracoding.CSmaster.model.MenuHeader;
...
public class GenerateMenuString {
        ...
        public String menuInnerHtml(Akses akses)
    {
        ...
        {
            MenuHeader menuHeader = listMenuz.get(i).getMenuHeader();//handling exception null, group not set
            namaMenuHeader = menuHeader==null?"UNGROUP":menuHeader.getNamaMenuHeader();
            sBuild.setLength(0);
