...
//    public final static String ERROR_DATE_FORMAT_DDMMYYYY = "FORMAT TANGGAL TIDAK SESUAI (dd-MM-YYYY)";
    ...
    public final static String WARNING_PEMBAYARAN_NOT_EXISTS = "LIST PEMBAYARAN TIDAK DOTEMUKAN";

    /*
        PELANGGAN
     */

    public final static String WARNING_PELANGGAN_NOT_EXISTS = "CUSTOMER  TIDAK DOTEMUKAN";

    /*
        PAKET LAYANAN
     */
    public final static String WARNING_PAKET_LAYANAN_NOT_EXISTS = "PAKET LAYANAN TIDAK DOTEMUKAN";
    ...
    public static final String WARNING_CATEGORY_NOT_EXISTS = "CATEGORY TIDAK DITEMUKAN";
    public static final String WARNING_COMPLAIN_NOT_EXISTS ="COMPLAIN TIDAK DITEMUKAN" ;
    public static final String WARNING_KODE_PRODUCT_LENGTH = "PRODUCT TIDAK DITEMUKAN";
	public static final String WARNING_PRODUCT_NAME_LENGTH = "PRODUCT GA ADA";
	public static final String WARNING_MERK_PRODUCT_LENGTH = "TIDAK ADA MERK ITU";
	public static final String WARNING_DESCRIPTION_NAME_LENGTH = "ANDA KURANG BERUNTUNG";
}
