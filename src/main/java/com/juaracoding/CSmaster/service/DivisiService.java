...
import com.juaracoding.CSmaster.repo.DivisiRepo;
...
public class DivisiService {
	...
	public List<DivisiDTO> dataToExport(WebRequest request, String columFirst, String valueFirst)
	{
		...
		try
		{
			...
			listDivisi = getDataToExport(columFirst,valueFirst);
	...
	private List<Divisi> getDataToExport(String paramColumn, String paramValue)
	{
		if(paramValue.equals(""))
		{
			return divisiRepo.findByIsDelete((byte) 1);
		}
		if(paramColumn.equals("id"))
		{
			return divisiRepo.findByIsDeleteAndIdDivisi((byte) 1,Long.parseLong(paramValue));
		} else if (paramColumn.equals("nama")) {
			return divisiRepo.findByIsDeleteAndNamaDivisiContainsIgnoreCase((byte) 1,paramValue);
		}
