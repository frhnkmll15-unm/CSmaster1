...
public class ReportService {
    ...
    @Autowired
    public ReportService(CategoryRepo categoryRepo) {
        mapColumn();
//        listItemPerPage();
    ...
    public List<Category> findAllCategory() {
        return categoryRepo.findByIsDelete((byte)1);
    }
	...
	public List<CategoryDTO> dataToExport(WebRequest request, String columFirst, String valueFirst)
	{
		...
		try
		{
			...
			listCategory = getDataToExport(columFirst,valueFirst);
	...
	private List<Category> getDataToExport(String paramColumn, String paramValue)
	{
		...
		{
			return categoryRepo.findByIsDeleteAndIdCategory((byte) 1,Long.parseLong(paramValue));
		} else if (paramColumn.equals("nama")) {
			return categoryRepo.findByIsDeleteAndNamaCategoryContainsIgnoreCase((byte) 1,paramValue);
		}
